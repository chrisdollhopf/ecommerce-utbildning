        ...
        <div class="max-w-md lg:flex-none rounded overflow-hidden shadow-xl m-3">
          <div class="h-56 bg-cover bg-no-repeat" style="background-image: url({{ asset('images/mobile-code-over.jpg') }})">
            ...
            <div class="bg-white px-6 py-4">
              ...
              <div class=" px-6 py-4">
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">Höst</span>
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">Distans</span>
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">Heltid</span>
              </div>
          </div>
        </div>
        ...
        <div class="max-w-md lg:flex-none rounded overflow-hidden shadow-xl m-3">
          <div class="h-56 bg-cover bg-no-repeat" style="background-image: url({{ asset('images/mobile-pad-over.jpg') }})">
            ...
            <div class="bg-white px-6 py-4">
              ...
              <div class="px-6 py-4">
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">Vinter</span>
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">Distans</span>
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">Deltid</span>
              </div>
          </div>
        </div>
        ...
        <div class="max-w-md lg:flex-none rounded overflow-hidden shadow-xl m-3">
          <div class="h-56 bg-cover bg-no-repeat" style="background-image: url({{ asset('images/mobile-screen-over.jpg') }})">
            ...
            <div class="bg-white px-6 py-4">
              ...
              <div class="px-6 py-4">
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">Vår</span>
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">Distans</span>
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">Heltid</span>
              </div>
          </div>
